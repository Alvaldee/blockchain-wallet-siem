...
## 5.1 Core Philosophy
“Possession of a private key does not equal user intent.” The system assumes attackers:
- Optimize for speed
- Use automation
...
Rule ID	Description:
1. ≥3 outgoing tx within 60s
2.	New recipient + large value
3.	Unlimited approval to new spender
4.	Approval followed by transferFrom
5.	Multiple tokens to same address
6.	First-ever contract interaction
7.	Sudden chain or token change
8.	Gas price anomaly
9.	Contract with upgradeable proxy
10.	Known malicious address (optional)  
